                ...
                if (this.proposalStarted()){
                    if (!this.proposalEnded()){
                        ...
                        this.setState({
                            ...
                            proposalValid: totalVotes.dividedBy(totalVotingPower.multipliedBy(Meteor.settings.public.powerReduction)).comparedTo(Meteor.settings.public.tallyParams.quorum) == 1 ? true : false
                        })
                    }
                    else{
                                            ...
                                            <em>
                                                ...
                                                {this.state.proposalValid ? 
                                                    ...
                                                    (this.state.voteEnded) ?
                                                        <T _props={{className:'text-danger'}} quorum={numbro(Meteor.settings.public.tallyParams.quorum).format("0.00%")} _purify={false}>proposals.invalidMessage</T>
                                                        : <T moreVotes={totalVotingPower.multipliedBy(Meteor.settings.public.tallyParams.quorum).minus(this.state.totalVotes).dividedBy(Meteor.settings.public.powerReduction).toString(10)} _purify={false}>proposals.moreVoteMessage</T>
                                                }
                                            </em>
                                        </Card>
                                    </Col>
